  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        {/* Outer content container - only used when NO background slides exist to render standard text layout */}
        {!hasSlides && (
        ...
        {hasSlides && slides.length > 1 && (
          <>
            <button
              ...
              className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-slate-950/40 hover:bg-[#1e66f5] hover:scale-105 active:scale-95 text-white flex items-center justify-center transition-all cursor-pointer backdrop-blur-md border border-white/10 select-none animate-fade-in"
            ...
            <button
              ...
              className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-slate-950/40 hover:bg-[#1e66f5] hover:scale-105 active:scale-95 text-white flex items-center justify-center transition-all cursor-pointer backdrop-blur-md border border-white/10 select-none animate-fade-in"
